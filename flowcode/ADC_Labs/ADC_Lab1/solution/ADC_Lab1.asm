...
; Heap block 1, size:74 (0x00000026 - 0x0000006F)
__HEAP_BLOCK1_BANK               EQU	0x00000000
__HEAP_BLOCK1_START_OFFSET       EQU	0x00000026
...
FCD_ADC0_S_0001E_1_old_tris      EQU	0x00000024 ; bytes:1
FCD_ADC0_S_0001E_1_cnt           EQU	0x00000025 ; bytes:1
CompTempVarRet623                EQU	0x00000024 ; bytes:1
...
; { FCD_ADC0_SampleADC ; function begin
	...
	MOVF gbl_trisb, W
	BCF STATUS, RP0
	MOVWF FCD_ADC0_S_0001E_1_old_tris
	MOVLW 0x10
	BSF STATUS, RP0
	IORWF gbl_trisb, W
	MOVWF gbl_trisb
	...
	BCF STATUS, RP0
	MOVWF gbl_adcon0
	CLRF FCD_ADC0_S_0001E_1_cnt
label268439663
	MOVLW 0x28
	SUBWF FCD_ADC0_S_0001E_1_cnt, W
	BTFSC STATUS,C
	GOTO	label268439664
	INCF FCD_ADC0_S_0001E_1_cnt, F
	GOTO	label268439663
label268439664
	MOVLW 0x02
	IORWF gbl_adcon0, W
...
label268439668
	BTFSC gbl_adcon0,1
	GOTO	label268439668
	MOVF FCD_ADC0_S_0001E_1_old_tris, W
	BSF STATUS, RP0
	MOVWF gbl_trisb
	BCF STATUS, RP0
	BSF STATUS, RP1
...
label268439698
	CALL FCD_ADC0_S_0001E
	CALL FCD_ADC0_R_0001F
