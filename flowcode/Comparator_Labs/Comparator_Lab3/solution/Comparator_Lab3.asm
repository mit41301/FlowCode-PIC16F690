...
gbl_FCV_COUNTER                  EQU	0x00000023 ; bytes:1
gbl_FCV_LED_OUTPUT               EQU	0x00000024 ; bytes:1
...
; } delay_ms function end
	...
	ORG 0x0000001C
FCM_TMR0_I_0001E
; { FCM_TMR0_ISR ; function begin
	BCF STATUS, RP0
	BCF STATUS, RP1
	SWAPF gbl_FCV_COUNTER, W
	ANDLW 0xF0
	MOVWF gbl_FCV_LED_OUTPUT
	CLRF gbl_FCV_COUNTER
	RETURN
; } FCM_TMR0_ISR function end

	ORG 0x00000023
FCM_Init_P_0001D
; { FCM_Init_Peripherals ; function begin
	BSF STATUS, RP0
	BCF STATUS, RP1
	BCF gbl_trisc,4
	MOVLW 0xA1
	...
	CLRF gbl_FCV_COUNTER
	RETURN
; } FCM_Init_Peripherals function end
