...
CompTempVar623                   EQU	0x00000024 ; bytes:1
delay_ms_00000_arg_del           EQU	0x00000025 ; bytes:1
delay_s_00000_arg_del            EQU	0x00000024 ; bytes:1
